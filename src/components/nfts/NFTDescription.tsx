        ...
        <div className="w-full flex flex-col items-end gap-2 mb-4">
          {isExpanded && (
            <>
              <Link
                href="#"
                title={`https://memora.voyage.co.id/[chain-name]/[contract-address]/${tokenIdString}`}
                target="_blank"
              ...
              <Link
                href="#"
                title={`https://store.endhonesa.com/digital/[chain-name]/[contract-address]/${tokenIdString}`}
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  color: colorSecondary,
