...
export const featuredPaid = "/roti/images/featured-paid.png";
export const paidTitle = "Paid Virtual Collectible";
export const featuredFree = "/roti/images/featured-free.png";
export const freeTitle = "Free Virtual Collectible";
export const featuredCoin = "/roti/images/featured-coin.png";
...
export const nftListerImage = "/roti/medias/virtual-collectible.gif"; // nft form,
...
// bon dosh modal fts
export const popUpTitle = "$BON Dosh!!!!";
export const popUpP1 = "At a certain point in time… in the Realm of Reality.";
...
export const popUpUlLi1 = "🔹 How far has the VOYAGE taken them?";
export const popUpUlLi2 = "🔹 How much value has been forged along the way?";
export const popUpUlLi3 = "🔹 How many encounters have shaped the path?";
export const popUpUlLi4 =
  "🔹 How much revenue has been channelled and exchanged?";
export const popUpP9 =
...
export const popUpP10 = "BON VOYAGE! 🚀";
export const popUpP11 = "🍌☕🍌☕";
export const popUpP12 = "Prof. NOTA v.11.11.11";
export const popUpImage = "/medias/bon-voyage.gif";
export const popUpImageAlt = "BON VOYAGE Token Illustration";
...
export const linkPower = "https://voyage.co.id/"; // login layout
export const footerPower = "/images/footer-power.png";
export const poweredBy = "Powered by Bon Voyage Protocol"; // login layout
...
export const linkInstagram = "https://www.instagram.com/voyage.web3/";
export const linkYouTube = "https://www.youtube.com/@voyageweb3";
