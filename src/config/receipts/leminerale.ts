...
export const leminerale = {
  ...
  proLogo: "/leminerale/logos/logo.png", // connect buttons, connect embeds,

  // login layout section
  loginArt: "/leminerale/images/login-art.png", // login layout,
  loginBanner: "/leminerale/images/login-banner.png", // login layout,
  ...
  footerPower: "/leminerale/images/footer-power.png", // footer,
  ...
  featuredPaid: "/leminerale/images/featured-paid.png", // featured cards,
  paidTitle: "Koleksi Digital Berbayar", // featured cards,
  featuredFree: "/leminerale/images/featured-free.png", // featured cards,
  freeTitle: "Koleksi Digital Gratis", // featured cards,
  featuredCoin: "/leminerale/images/featured-coin.png", // featured cards,
  ...
  nftListerImage: "/leminerale/medias/artisan-bread.png", // nft lister, nft form,
